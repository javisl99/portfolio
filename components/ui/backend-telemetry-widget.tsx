  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 overflow-x-hidden p-4 sm:p-5">
        {activeTab === "architecture" ? (
          <div aria-labelledby="profile-tab" className="min-w-0 space-y-3 font-mono text-[0.76rem] leading-relaxed" id="profile-panel" role="tabpanel" tabIndex={0}>
        ...
        {activeTab === "telemetry" ? (
          <div aria-labelledby="telemetry-tab" className="min-w-0 space-y-3" id="telemetry-panel" role="tabpanel" tabIndex={0}>
        ...
        {activeTab === "logs" ? (
          <div aria-labelledby="logs-tab" className="min-w-0 space-y-3 font-mono" id="logs-panel" role="tabpanel" tabIndex={0}>
            <div className="max-h-52 overflow-x-hidden overflow-y-auto rounded-xl border border-white/6 bg-black/60 p-3 text-[0.78rem] leading-relaxed text-slate-300 sm:max-h-44 sm:text-[0.72rem]">
              {logs.map((item, idx) => (
