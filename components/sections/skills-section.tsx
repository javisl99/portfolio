    ...
    <section className="py-18 sm:py-24" id="skills">
      <Container>
        ...
        <div className="mx-auto mb-10 max-w-3xl space-y-4 text-center">
          ...
          <div className="mx-auto h-px w-24 bg-[linear-gradient(90deg,transparent,#60a5fa,#818cf8,transparent)]" />
        </div>

        {aiTitle && aiDescription && aiItems.length > 0 ? (
          <div className="mb-8 grid gap-6 lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]">
            <article className="rounded-[2rem] border border-white/10 bg-[linear-gradient(160deg,rgba(14,23,42,0.96),rgba(6,10,22,0.98))] p-8 shadow-[0_36px_80px_-42px_rgba(37,99,235,0.34)] sm:p-10">
              <p className="mb-4 font-mono text-[0.7rem] font-bold uppercase tracking-[0.24em] text-[#bcd1ff]">AI-Assisted Engineering</p>
